...
import { axiosWithCredentials } from "../../../server/axiosin";  // import axios instance me config
...
const Checkout = () => {
  ...
  const fetchCartItems = async () => {
    try {
      const response = await axiosWithCredentials.get("/api/user/order/cart/items");
  ...
  const handlePlaceOrder = async () => {
    setLoading(true);
    try {
      const response = await axiosWithCredentials.post("/api/user/order/from-cart", {});
